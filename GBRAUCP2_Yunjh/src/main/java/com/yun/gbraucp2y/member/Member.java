...
public class Member {
	...
	public Member(String ym_id, String ym_pw, String ym_name, Date ym_birthday, String ym_address, String ym_photo) {
		super();
		this.ym_id = ym_id;
		this.ym_pw = ym_pw;
		this.ym_name = ym_name;
		this.ym_birthday = ym_birthday;
		this.ym_address = ym_address;
	...
	public String getYm_address() {
		return ym_address;
	}

	public void setYm_address(String ym_address) {
		this.ym_address = ym_address;
	}
