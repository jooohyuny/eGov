...
<body>
	<form action="member.join" method="post" 
		...
		<table id="memberJoinTbl">
			...
			<tr>
				<td align="center">
					<input name="gm_id" class="textType" placeholder="ID" maxlength="10" autocomplete="off" autofocus="autofocus">
				</td>
			</tr>
			<tr>
				<td align="center">
			...
			<tr>
				<td align="center">
					<input name="gm_address1" class="textType" placeholder="우편번호" autocomplete="off"><br>
					<input name="gm_address2" class="textType" placeholder="주소" autocomplete="off"><br>
